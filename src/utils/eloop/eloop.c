...
#define wpa_printf(...) (NULL)
#define wpa_trace_record(...) (NULL)
#define wpa_trace_add_ref(...) (NULL)
#define wpa_trace_remove_ref(...) (NULL)
#define wpa_trace_dump(...) (NULL)
#define wpa_trace_dump_funcname(...) (NULL)
#define WPA_TRACE_REF(name) char: 0
