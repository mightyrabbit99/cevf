...
#define cevf_start(argc, argv, cm_thr_cnt) cevf_run(argc, argv, _cevf_ini_arr, _cevf_ini_arr_sz, _cevf_pd_arr, _cevf_pd_arr_sz, _cevf_cm_t1_arr, _cevf_cm_t1_arr_sz, _cevf_cm_t2_arr, _cevf_cm_t2_arr_sz, cm_thr_cnt);
