...
#define _cevf_mod_add_initialiser(_init_f, _deinit_f)                                                                                  \
  do {                                                                                                                                 \
    _cevf_ret = 0;                                                                                                                     \
    if (_cevf_ini_arr_sz == (cevf_asz_t) - 1) {                                                                                        \
      _cevf_ret = -1;                                                                                                                  \
      break;                                                                                                                           \
    }                                                                                                                                  \
    _cevf_tmp_ini_p = (struct cevf_initialiser_s *)realloc(_cevf_ini_arr, (_cevf_ini_arr_sz + 1) * sizeof(struct cevf_initialiser_s)); \
    if (_cevf_tmp_ini_p == NULL) {                                                                                                     \
      _cevf_ret = -1;                                                                                                                  \
      break;                                                                                                                           \
    }                                                                                                                                  \
    _cevf_ini_arr = _cevf_tmp_ini_p;                                                                                                   \
    _cevf_ini_arr[_cevf_ini_arr_sz++] = (struct cevf_initialiser_s){                                                                   \
        .init_f = _init_f,                                                                                                             \
        .deinit_f = _deinit_f,                                                                                                         \
    };                                                                                                                                 \
  } while (0)
#define cevf_mod_add_initialiser(init_f, deinit_f) \
  do {                                             \
    _cevf_mod_add_initialiser(init_f, deinit_f);   \
